...
*/
::Const.Contracts.NegotiationItemsOnly <- [{
	ID = "Negotiation",
	Title = "Negotiations",
	Text = "",
	Image = "",
	...
	function start() {
		...
		if (this.Contract.m.Payment.Items.len() != 0) {
			this.Text += "{You\'ll get | You are to receive | You\'ll be paid | It\'s} this pile of %reward_item_count% items when the contract is done.%SPEECH_OFF%";
