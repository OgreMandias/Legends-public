...
::Legends.Armor.Barbarian.animal_hide_armor <- {
	...
	Sets = [{
		...
		Plate = [
			[1, "plate/legend_armor_animal_hide_armor"], // 30
		],
		Cloak = [
		],
		Tabard = [
...
::Legends.Armor.Barbarian.heavy_iron_armor <- {
	...
	Sets = [{
		...
		Plate = [
			[1, "plate/legend_armor_thick_plated_barbarian_armor"], // 155
		],
		Cloak = [
			[1, "cloak/legend_armor_cloak_fur"], // 10
		],
		Tabard = [
		],
		Attachments =[
...
::Legends.Armor.Barbarian.reinforced_heavy_iron_armor <- {
	...
	Sets = [{
		...
		Plate = [
			[1, "plate/legend_armor_heavy_iron_armor"], // 120
		],
		Cloak = [
		],
		Tabard = [
...
::Legends.Armor.Barbarian.hide_and_bone_armor <- {
	...
	Sets = [{
		...
		Plate = [
			[1, "plate/legend_armor_hide_and_bone_armor"], // 80
		],
		Cloak = [
		],
		Tabard = [
...
::Legends.Armor.Barbarian.reinforced_animal_hide_armor <- {
	...
	Sets = [{
		...
		Plate = [
			[1, "plate/legend_armor_animal_hide_armor_reinforced"], // 55
		],
		Cloak = [
		],
		Tabard = [
...
::Legends.Armor.Barbarian.rugged_scale_armor <- {
	...
	Sets = [{
		...
		Plate = [
			[1, "plate/legend_armor_rugged_scale_armor"], // 95
		],
		Cloak = [
		],
		Tabard = [
...
::Legends.Armor.Barbarian.legend_barbarian_southern_armor <- {
	...
	Sets = [{
		...
		Plate = [
			[1, "plate/legend_armor_southern_arm_guards"], // 30
		],
		Cloak = [
		],
		Tabard = [
...
::Legends.Armor.Barbarian.scrap_metal_armor <- {
	...
	Sets = [{
		Cloth = [
			[1, "cloth/legend_armor_ancient_cloth"], // 30
			[1, "cloth/legend_armor_sackcloth"], // 10
			[1, "cloth/legend_armor_sackcloth_patched"], // 15
		],
		Chain = [
		...
		Plate = [
			[1, "plate/legend_armor_scrap_metal_armor"], // 65
		],
		Cloak = [
		],
		Tabard = [
...
::Legends.Armor.Barbarian.thick_furs_armor <- {
	...
	Sets = [{
		...
		Plate = [
			[1, "plate/legend_armor_thick_furs_armor"], // 10
		],
		Cloak = [
		],
		Tabard = [
