...
::Legends.Armor.Mercenary.mercenary_archer_armor_01 <- {
	...
	Sets = [{
		Cloth = [
			[1, "cloth/quilted_aketon", 26]
		],
		Chain = [
		],
		Plate = [
			[1, "plate/leather_jacket", 2],
			[1, "plate/leather_jacket_simple", 2]
		],
		Cloak = [
		],
		Tabard = [
...
::Legends.Armor.Mercenary.mercenary_infantry_armor_00 <- {
	...
	Sets = [{
		...
		Chain = [
			[4, "chain/hauberk_sleeveless"], // 65
			[4, "chain/basic_mail"], // 85
			[3, "chain/hauberk"], // 95
...
::Legends.Armor.Mercenary.mercenary_infantry_armor_01 <- {
	...
	Sets = [{
		Cloth = [
			[5, "cloth/tunic", 4],
			[2, "cloth/gambeson", [1,2]],
			[2, "cloth/quilted_aketon", [1,26]],
			[1, "cloth/gambeson_wolf"]
		],
		Chain = [
...
::Legends.Armor.Mercenary.mercenary_crossbow_armor_00 <- {
	...
	Sets = [{
		...
		Chain = [
			[1, "chain/hauberk_sleeveless"], // 65
			[1, "chain/reinforced_mail_shirt"], // 85
			[1, "chain/mail_shirt"], // 85
			[1, "chain/short_mail"] // 85
		],
		Plate = [
			[1, "plate/leather_lamellar"],
			[1, "plate/leather_lamellar_reinforced"],
...
::Legends.Armor.Mercenary.mercenary_leader_armor_uncommon_00 <- {
	...
	Sets = [{
		Cloth = [
			[1, "cloth/tunic"] //not shown doesn't matter variant
		],
		Chain = [
			[1, "chain/reinforced_mail_shirt"]
		],
		Plate = [
			[1, "plate/thick_plated_barbarian_armor"]
		],
		Cloak = [
		],
		Tabard = [
...
::Legends.Armor.Mercenary.mercenary_leader_armor_00 <- {
	...
	Sets = [{
		...
		Tabard = [
			[4, ""],
			[1, "tabard/southern_shoulder_cloth", 4]
		],
		Attachments =[
			[9, ""],
			[1, "armor_upgrades/legend_leather_shoulderguards_upgrade"]
...
::Legends.Armor.Mercenary.mercenary_leader_armor_gilded_00 <- {
	...
	Sets = [{
		Cloth = [
			[1, "cloth/southern_gladiator_harness"]
		],
		Chain = [
		],
		Plate = [
