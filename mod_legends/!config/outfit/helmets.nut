...
::Legends.Helmet.Standard.bascinet_with_mail <- {
	...
	Sets = [{
		...
		Helms = [
			[1, "helm/legend_helmet_bascinet"], // 130, -8, -1
		],
		Tops = [],
		Vanity = [
			[5, ""],
...
::Legends.Helmet.Standard.closed_flat_top_helmet <- {
	...
	Sets = [{
		...
		Helms = [
			[1, "helm/legend_helmet_flat_top_helm_rusted"] //90, -6, -1
		],
		Tops = [
...
::Legends.Helmet.Standard.closed_flat_top_with_mail <- {
	...
	Sets = [{
		...
		Helms = [
			[1, "helm/legend_helmet_flat_top_helm"] //150, -11, -1
		],
		Tops = [
			[1, "top/legend_helmet_faceplate_flat"] //30, -2, -2
		],
...
::Legends.Helmet.Standard.decayed_great_helm <- {
	...
	Sets = [{
		...
		Vanity = [
			[1, "vanity/legend_helmet_rotten_faction_helmet"], //10, -1, 0
		]
	}]
};
...
::Legends.Helmet.Standard.legend_helm_wings <- {
	...
	Sets = [{
		...
		Tops = [
			...
			[1, "top/legend_helmet_faceplate_winged_full"], //65, -7, -1
			[1, "top/legend_helmet_faceplate_winged_long"], //40, -4, -1
		],
		Vanity = []
	}]
};
...
::Legends.Helmet.Standard.kettle_hat <- {
	...
	Sets = [{
		...
		Helms = [
			[20, "helm/legend_helmet_kettle_helm_rusted"],
			[1, "helm/legend_helmet_kettle_helm"],
...
::Legends.Helmet.Standard.padded_kettle_hat <- {
	...
	Sets = [{
		...
		Helms = [
			[1, "helm/legend_helmet_kettle_helm_rusted"],
			[20, "helm/legend_helmet_kettle_helm"],
			[1, "helm/legend_helmet_kettle_helm_high"], //75
			[1, "helm/legend_helmet_kettle_hat"]
		],
		Tops = [],
...
::Legends.Helmet.Standard.legend_enclave_vanilla_armet_01 <- {
	...
	Sets = [{
		...
		Vanity = [
			...
			[1, "vanity/legend_helmet_back_feathers"],
		]
	}]
};
...
::Legends.Helmet.Standard.barbarian_chosen_helmet_00 <- {
	...
	Sets = [{
		...
		Tops = [
			[1, "top/legend_helmet_barb_hood_leather"]
		],
		Vanity = [
			[1, "vanity/legend_helmet_orc_bones"],
...
::Legends.Helmet.Standard.adorned_closed_flat_top_with_mail <- {
	...
	Sets = [{
		...
		Helms = [
			[1, "helm/legend_helmet_flat_top_helm_rusted"],
...
::Legends.Helmet.Standard.adorned_full_helm_rotten <- {
	...
	Sets = [{
		...
		Tops = [
			[1, "top/legend_helmet_rotten_helm_adornment"],
		],
		Vanity = [
			[1, "vanity/legend_helmet_rotten_thick_braid"],
		]
	}]
};
...
::Legends.Helmet.Standard.masked_kettle_helmet <- {
	...
	Sets = [{
		...
		Helms = [
			...
			[3, "helm/legend_helmet_kettle_helm_rusted"],
			[2, "helm/legend_helmet_kettle_helm"],
			[1, "helm/legend_helmet_kettle_helm_high"],
		],
		Tops = [
