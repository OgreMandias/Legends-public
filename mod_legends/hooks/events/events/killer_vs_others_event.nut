::mods_hookExactClass("events/events/killer_vs_others_event", function(o) {
	...
	o.create = function() {
		...
		foreach (s in this.m.Screens) {
			...
			if (s.ID == "E") {
				s.Text = "[img]gfx/ui/events/event_64.png[/img]The call for cooler heads to prevail seems to have failed as %killer%\'s body is found dead anyway. {It appears someone stabbed the killer in the back. | Someone garroted the killer with a line of strong linen. | %killer% was nearly chopped in half, the work of a truly angry person. | %killer%\'s head was found resting next to their chest, hands placed in such a manner as to be holding it. | Emphasis on the word \'body\', as the head was nowhere to be found. | Someone had slit %killer% \'s throat in the night. | Bruises on the body and cuts on the hands suggests a fight, but whoever it was managed to gut the killer anyway.} You have a good guess as to who did it, but none of the mercenaries seem all that upset about the killer\'s death and certain proof would elude any kind of investigation. While all of that may be true, you still order the suspected mercenary to help bury the dead.";
				s.start <- function ( _event ) {
