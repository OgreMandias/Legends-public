::mods_hookExactClass("items/weapons/ancient/broken_bladed_pike", function(o) {
	...
	o.updateVariant <- function() {
		...
		this.m.Icon = "weapons/melee/broken_pike_01_" + this.m.Variant + "_70x70.png";
		this.m.IconLarge = "weapons/melee/broken_pike_01_" + this.m.Variant + ".png";
		this.m.ArmamentIcon = "icon_bladed_pike_02_" + this.m.Variant;
	}
