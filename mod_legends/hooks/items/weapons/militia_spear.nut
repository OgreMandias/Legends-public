::mods_hookExactClass("items/weapons/militia_spear", function(o) {
	...
	o.updateVariant <- function() {
		...
		this.m.Icon = "weapons/melee/spear_02_" + this.m.Variant + "_70x70.png";
		this.m.IconLarge = "weapons/melee/spear_02_" + this.m.Variant + ".png";
		this.m.ArmamentIcon = "icon_spear_02_" + this.m.Variant;
	}
