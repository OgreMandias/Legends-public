::mods_hookExactClass("items/weapons/reinforced_wooden_flail", function(o) {
	...
	o.updateVariant <- function() {
		...
		this.m.Icon = "weapons/melee/flail_03_" + this.m.Variant + "_70x70.png";
		this.m.IconLarge = "weapons/melee/flail_03_" + this.m.Variant + ".png";
		this.m.ArmamentIcon = "icon_flail_03_" + this.m.Variant;
	}
