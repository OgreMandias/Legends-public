::mods_hookExactClass("scenarios/tactical/scenario_ghouls", function(o)
{
	o.initEntities = function ()
	{
		...
		items.equip(this.new("scripts/items/ammo/quiver_of_arrows"));
		items.addToBag(this.new("scripts/items/weapons/dagger"));
		entity = this.spawnEntity("scripts/entity/tactical/enemies/legend_mummy_light", 12, 18, 7, 10);
		...
		entity.setFaction(this.Const.Faction.Undead);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/legend_mummy_light", 20, 22, 12, 18);
		entity.setFaction(this.Const.Faction.Undead);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/legend_mummy_light", 20, 22, 12, 18);
		entity.setFaction(this.Const.Faction.Undead);
		...
		entity.setFaction(this.Const.Faction.Undead);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/legend_mummy_light", 21, 22, 16, 20);
		entity.setFaction(this.Const.Faction.Undead);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/legend_mummy_light", 7, 10, 12, 18);
		entity.setFaction(this.Const.Faction.Undead);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/legend_mummy_light", 7, 10, 12, 18);
		entity.setFaction(this.Const.Faction.Undead);
		...
		entity.setFaction(this.Const.Faction.Undead);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/legend_mummy_light", 13, 17, 21, 23);
		entity.setFaction(this.Const.Faction.Undead);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/legend_mummy_light", 13, 17, 21, 23);
		entity.setFaction(this.Const.Faction.Undead);
