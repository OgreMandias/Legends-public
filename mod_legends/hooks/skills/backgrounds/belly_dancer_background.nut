::mods_hookExactClass("skills/backgrounds/belly_dancer_background", function(o)
{
	o.create = function ()
	{
		...
		this.m.BadEnding = "As the company failed to achieve the success you had hoped for, many departed its ranks. The southern belly dancer joined them. Unfortunately, %name% sought to ply their trade in the north, thinking they may be able to spread culture there. The indigenous population was quick to accuse her of \'unregulated body sorcery\' and burn %name% at the stake.";
