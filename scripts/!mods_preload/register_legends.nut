...
::mods_queue(::Legends.ID, "mod_msu(>=1.7.0), mod_legends_assets(>=19.2.0-alpha10), vanilla(>=1.5.1-5), dlc_lindwurm, dlc_unhold, dlc_wildmen, dlc_desert, dlc_paladins, mod_events_delayed_fix_legends, !mod_tooltip_extension(<=1.01)", function()
{
