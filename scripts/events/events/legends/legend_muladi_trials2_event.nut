//Muladi Trials 2
//Conditions:
//- Must have 1x Muladi bro with the flag MuladiTrials from EV1
//- Must have been at least 15 days since EV1 occurred.
//- Must be within 4 tiles of a non-southern settlement.
//- No brother must have the flags “MuladiTrials2” or “MuladiTrials3”.



this.legend_Muladi_Trials2_event <- this.inherit("scripts/events/legends", {
  m = {
    Muladi = null,
  },
  function create() {
    ...
    this.m.Screens.push({
      ...
      Title = "On the outskirts of %settlement%...”
      Image = "",
      List = [],
      Characters = [],
      Options = [{
  ...
  this.m.Screens.push({
    ...
    Options = [{
        ...
        getResult = @(_event) 0
        //Consequences:
        //- Muladi bro receives major damage AND receives one major temporary puncture injury (punctured lung, stabbed guts, grazed kidney, pierced chest).
        //- Muladi bro receives a mood penalty of 2.
        //- Muladi bro loses -4 resolve and -4-8 health.
        //- Muladi bro receives flag “MuladiTrials2”
        //- Half of the company receives a mood bonus of 1.
        //- Receive a moderate drop in relations with the nearest settlement.

//Mood modifier for men who received minor mood bonus: “Dished out vengeance against violent peasants.”
  this.m.Screens.push({
    ID = "2"
    Title = "Back at camp..."
    ...
    Options = [{
        ...
        getResult = @(_event) 0
        //- Muladi bro receives major damage AND receives one major temporary puncture injury.
        //- Muladi bro receives a mood penalty of 2.
        //- Muladi bro loses -4 resolve and -4-8 health.
        //- Muladi bro receives flag “MuladiTrials2”
        //- Half of the company receives a mood penalty of 1.

//Mood modifier for men who received minor mood penalty: “Denied vengeance against violent peasants.”
//Mood modifier for Muladi bro: “Was almost killed by my countrymen!”
