this.legend_armor_skill_book_item <- ::inherit("scripts/items/misc/legend_skill_book", {
	...
	function create()
	{
		...
		this.m.Description = format("A collection of notes of soldiers, craftsmen and armorers, that will explain everything about wearing armor. Will teach the [color=%s]%s[/color] perk group from armor perk trees to the character that uses it.", ::Const.UI.Color.NegativeValue, this.m.PerkGroupSelection);
