this.legend_enemy_skill_book_item <- ::inherit("scripts/items/misc/legend_skill_book", {
	...
	function create()
	{
		...
		this.m.Description = format("Compendium in fighting particular enemies and their relevant weak spots.  Will teach the relevant [color=%s]Enemy[/color] perk group to the character that uses it.", ::Const.UI.Color.NegativeValue);
