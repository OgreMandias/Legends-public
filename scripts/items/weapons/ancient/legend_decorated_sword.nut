this.legend_decorated_sword <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/ancient_sword_01_1.png";
		this.m.Icon = "weapons/melee/ancient_sword_01_1_70x70.png";
		...
		this.m.ArmamentIcon = "icon_ancient_sword_01_1";
		this.m.Value = 1300;
