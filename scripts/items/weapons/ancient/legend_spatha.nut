this.legend_spatha <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/ancient_sword_01_2.png";
		this.m.Icon = "weapons/melee/ancient_sword_01_2_70x70.png";
		...
		this.m.ArmamentIcon = "icon_ancient_sword_01_2";
		this.m.Value = 1550;
