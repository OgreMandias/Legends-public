this.legend_named_estoc <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "To craft a wellmade Estoc is difficult, requiring both a stiff and elegant for the thrust of a swift and mobile fencer. Yet, the smith that crafted this did more than craft a wellmade one, he crafted a masterpiece.";
