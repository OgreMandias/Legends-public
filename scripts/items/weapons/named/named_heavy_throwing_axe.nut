this.named_heavy_throwing_axe <- inherit("scripts/items/weapons/named/named_weapon", {

	m = { }

	function isAmountShown() { return true; }
	function getAmountString() { return this.m.Ammo + "/" + this.m.AmmoMax; }

	function create() {
		this.named_weapon.create();

		this.m.ID = "weapon.named_heavy_throwing_axe";
