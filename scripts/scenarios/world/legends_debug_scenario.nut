this.legends_debug_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function onSpawnAssets()
	{
		...
		local armors = [
			"cloth/ancient_cloth",
			"cloth/ancient_cloth_restored",
			"cloth/apron_butcher",
			"cloth/apron",
			"cloth/southern_gladiator_harness",
			"cloth/gambeson",
			"cloth/gambeson_wolf",
			"cloth/gambeson_named",
			"cloth/quilted_aketon",
			"cloth/peasant_dress",
			"cloth/robes",
			"cloth/robes_magic",
			"cloth/robes_wizard",
			"cloth/robes_nun",
			"cloth/sackcloth_tattered",
			"cloth/sackcloth",
			"cloth/sackcloth_patched",
			"cloth/thick_tunic",
			"cloth/tunic",
			"cloth/tunic_wrap",
			"cloth/tunic_collar_thin",
			"cloth/tunic_collar_deep",
			"cloth/tunic_dark",
			"cloth/tunic_noble",
			"cloth/tunic_noble_named",
			"cloth/southern_robe",
			"cloth/southern_gambeson",
			"cloth/southern_split_gambeson",
			"cloth/southern_tunic",
			"cloth/southern_noble_aketon",
			"cloth/knightly_robe",
			"cloth/robes_anatomist",
			"cloth/wanderers_coat",
			"cloth/studded_aketon",

			"chain/ancient_double_mail",
			"chain/ancient_mail",
			"chain/basic_mail",
			"chain/hauberk",
			"chain/hauberk_full",
			"chain/hauberk_full_named",
			"chain/hauberk_sleeveless",
			"chain/mail_shirt",
			"chain/mail_shirt_simple",
			"chain/reinforced_mail",
			"chain/reinforced_mail_shirt",
			"chain/reinforced_rotten_mail_shirt",
			"chain/reinforced_worn_mail",
			"chain/reinforced_worn_mail_shirt",
			"chain/rusty_mail_shirt",
			"chain/short_mail",
			"chain/southern_cloth",
			"chain/southern_padded_chest",
			"chain/southern_mail",
			//"chain/wild_scale",

			"plate/leather_brigandine",
			"plate/leather_brigandine_hardened",
			"plate/leather_brigandine_hardened_full",
			"plate/leather_brigandine_named",
			"plate/leather_jacket",
			"plate/leather_jacket_named",
			"plate/leather_studded_jacket_named",
			"plate/leather_jacket_simple",
			"plate/leather_lamellar",
			"plate/leather_lamellar_harness_heavy",
			"plate/leather_lamellar_harness_reinforced",
			"plate/leather_lamellar_heavy",
			"plate/leather_lamellar_heavy_named",
			"plate/leather_lamellar_reinforced",
			"plate/leather_jacket_fine",
			"plate/leather_padded",
			"plate/leather_riveted",
			"plate/leather_riveted_light",
			"plate/leather_scale",
			"plate/plate_ancient_chest",
			"plate/plate_ancient_chest_restored",
			"plate/plate_ancient_gladiator",
			"plate/plate_ancient_harness",
			"plate/plate_ancient_mail",
			"plate/plate_ancient_scale",
			"plate/plate_ancient_scale_coat",
			"plate/plate_ancient_scale_harness",
			"plate/plate_chest",
			"plate/rotten_plate_chest",
			"plate/plate_cuirass",
			"plate/plate_full",
			"plate/plate_full_greaves",
			"plate/plate_full_greaves_named",
			"plate/plate_full_greaves_painted",
			"plate/scale",
			"plate/scale_coat",
			"plate/scale_coat_named",
			"plate/rotten_scale_coat",
			"plate/scale_shirt",
			"plate/animal_hide_armor",
			"plate/heavy_iron_armor",
			"plate/hide_and_bone_armor",
			"plate/animal_hide_armor_reinforced",
			"plate/rugged_scale_armor",
			"plate/scrap_metal_armor",
			"plate/thick_furs_armor",
			"plate/thick_plated_barbarian_armor",
			//"plate/southern_named_golden_plates",
			"plate/southern_named_plate",
			"plate/southern_plate",
			"plate/southern_plate_full",
			"plate/southern_padded",
			"plate/southern_arm_guards",
			"plate/southern_strips",
			"plate/southern_leather_jacket",
			"plate/southern_leather_plates",
			"plate/southern_leather_scale",
			"plate/southern_scale",
			"plate/apron_undertakers",

			"cloak/shoulder_cloth",
			"cloak/noble_shawl",
			"cloak/cloak_wooly_dark",
			"cloak/cloak",
			"cloak/cloak_heavy",
			"cloak/cloak_crusader",
			"cloak/cloak_noble",
			"cloak/sash",
			"cloak/southern_scarf",
			"cloak/animal_pelt",
			"cloak/southern_scarf_wrap",
			...
			"tabard/tabard",
			"tabard/tabard_noble",
			"tabard/southern_wrap_right",
			"tabard/southern_wrap_left",
			"tabard/southern_wide_belt",
			"tabard/noble_vest",
			"tabard/southern_wrap",
			"tabard/southern_shoulder_cloth",
			"tabard/southern_overcloth",
			"tabard/southern_tabard",
		...
		local helmets = [
			...
			"helm/legend_helmet_ancient_legionaire_restored",
